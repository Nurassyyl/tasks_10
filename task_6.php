...
$links = [
    [ "image" => "img/demo/authors/sunny.png",
      ...
      "a" => "https://twitter.com/@myplaneticket",
      "link" => "@myplaneticket",
                            ...
                            <?php foreach ($links as $link) { 
                               if ($link['banned'] == 0) { ?>
                                    <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                        <img src="<?php echo $link['image']; ?>" alt="Sunny A." class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                        <div class="ml-2 mr-3">
                                            <h5 class="m-0">
                                                <?php echo $link['name']; ?>
                                                <small class="m-0 fw-300">
                                                    <?php echo $link['profession']; ?>
                                                </small>
                                            </h5>
                                            <a href="<?php echo $link['a']; ?>" class="text-info fs-sm" target="_blank"><?php echo $link['link']; ?></a> -
                                            <a href="<?php echo $link['contact']; ?>" class="text-info fs-sm" target="_blank" title="Contact Sunny"><i class="fal fa-envelope"></i></a>
                                        </div>
                                    </div>
                               <?php }  else { ?>
                                         <div class="banned rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                            <img src="<?php echo $link['image']; ?>" alt="Jovanni Lo" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                            <div class="ml-2 mr-3">
                                                <h5 class="m-0">
                                                    <?php echo $link['name']; ?>
                                                    <small class="m-0 fw-300">
                                                ...
                                                <a href="<?php echo $link['a']; ?>" class="text-info fs-sm" target="_blank"><?php echo $link['link']; ?></a> 
                                                <a href="<?php echo $link['contact']; ?>" class="text-info fs-sm" target="_blank" title="Contact Jovanni"><i class="fal fa-envelope"></i></a>
                                            </div>
                                        </div>
                              <?php } 
                             } ?>
