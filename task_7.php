...
$links = mysqli_query($connect, " SELECT * FROM `course`");
                            ...
                            <?php foreach ($links as $link) {
                                if ($link['banned'] == 0) { ?>
                                    <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                        <img src="<?php echo $link['img_name']; ?>" alt="Sunny A." class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                        <div class="ml-2 mr-3">
                                            <h5 class="m-0">
                                                <?php echo $link['name']; ?>
                                            ...
                                            <a href="<?php echo $link['contact']; ?>" class="text-info fs-sm" target="_blank" title="<?php echo $link['email_link_title'] ?>"><?php echo $link['email_link_text'] ?></a>
                                        </div>
                                    </div>
                               <?php } elseif ($link['banned'] == 1) { ?>
                                    <div class="banned rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                        <img src="<?php echo $link['img_name']; ?>" alt="Jovanni Lo" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                        <div class="ml-2 mr-3">
                                            <h5 class="m-0">
                                                 <?php echo $link['name']; ?>
                                                <small class="m-0 fw-300">
